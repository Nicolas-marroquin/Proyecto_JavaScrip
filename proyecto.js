...
if (edad <18){
  alert ("porfavor abandone la pagina no es mayor de edad")
}
...
//Comprobamos la cantidad de propiedades que tiene a su nombre
var cantidad_propiedades
if("SI" == propiedades.toUpperCase()){ 
 cantidad_propiedades = prompt("cuantas propiedades tiene ")
  }
 
 var cantidad_propiedades =parseInt(cantidad_propiedades)
 ...
 */if (edad_conyuge_numero >=18 && edad_conyuge_numero<25){
 ...
 recargo_hijos = cantidad_hijos_numero * precio_base *hijos_recargo
recargo_total= recargo_total + recargo_hijos
 
var recargo_propiedades

recargo_propiedades = cantidad_propiedades_numero * precio_base * propiedades_recargo
recargo_total = recargo_total + recargo_propiedades


var recargo_sueldo

var sueldo_base=prompt("porfavor ingrese su sueldo")

var sueldo_base  =parseInt(sueldo_base)
var sueldo_base_numero=0
sueldo_base_numero= parseInt(sueldo_base)

recargo_sueldo= sueldo_base_numero * sueldo_recargo
...
opcion = prompt("desea ingresar otra persona si/no")
 }
